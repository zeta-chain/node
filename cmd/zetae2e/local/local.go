...
func localE2ETest(cmd *cobra.Command, _ []string) {
	...
	if testSui {
		suiTests := []string{
			...
			e2etests.TestSuiAuthenticatedCallName,
			e2etests.TestSuiAuthenticatedCallRevertWithCallName,
			...
			e2etests.TestSuiTokenAuthenticatedCallName,
			e2etests.TestSuiTokenAuthenticatedCallRevertWithCallName,
