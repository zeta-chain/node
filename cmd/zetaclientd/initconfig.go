...
func setupInitializeConfigOptions() {
	...
	f.BoolVar(&cfg.logSampler, "log-sampler", false, "set to true to turn on log sampling")
	...
	f.BoolVar(&cfg.TestTSSKeySign, "test-tss", false, "set to true to run a check for TSS keysign on startup")
