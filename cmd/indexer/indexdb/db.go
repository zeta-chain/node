...
func (idb *IndexDB) Rebuild() error {
    ...
    `, types.SendHash, types.InTxHash, types.Sender, types.SenderChain, types.Receiver, types.ReceiverChain, types.ZetaBurnt, types.ZetaMint)
...
func (idb *IndexDB) processFinalized(res *sdk.TxResponse, kv map[string]string) error {
	...
	_, err = idb.db.Exec(fmt.Sprintf("INSERT INTO  txs (%s, %s, %s, %s, %s, %s, %s, %s, Status, lastupdate) values($1,$2,$3,$4,$5,$6,$7,$10, $8, $9)",
		types.SendHash, types.InTxHash, types.Sender, types.SenderChain, types.Receiver, types.ReceiverChain, types.ZetaBurnt, types.ZetaMint),
