...
func (z *ZetacoreClientAdapter) InboundHashToCctxData(
	ctx context.Context,
	hash string,
) (*crosschaintypes.QueryInboundHashToCctxDataResponse, error) {
...
func (z *ZetacoreClientAdapter) GetOutboundTracker(
	ctx context.Context,
	chainID int64,
	nonce uint64,
...
func (z *ZetacoreClientAdapter) GetChainParamsForChainID(
	ctx context.Context,
	chainID int64,
) (*observertypes.ChainParams, error) {
	return z.clients.GetChainParamsForChainID(ctx, chainID)
}

// GetTssAddress retrieves TSS addresses (both EVM and BTC)
func (z *ZetacoreClientAdapter) GetTssAddress(
	ctx context.Context,
	btcChainID int64,
...
func (z *ZetacoreClientAdapter) GetBallotByID(
	ctx context.Context,
	id string,
) (*observertypes.QueryBallotByIdentifierResponse, error) {
