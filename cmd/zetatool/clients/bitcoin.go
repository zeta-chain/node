...
func NewBitcoinClientAdapter(
	cfg *config.Config,
	chain chains.Chain,
	logger zerolog.Logger,
) (*BitcoinClientAdapter, error) {
...
func (b *BitcoinClientAdapter) GetRawTransactionVerbose(
	ctx context.Context,
...
func (b *BitcoinClientAdapter) GetBlockVerbose(
	ctx context.Context,
	blockHash *chainhash.Hash,
) (*btcjson.GetBlockVerboseTxResult, error) {
