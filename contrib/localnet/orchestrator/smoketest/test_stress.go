...
func init() {
	...
	StressCmd.Flags().StringVar(&stressTestArgs.grpcURL, "grpcURL", "zetacore_node:9090", "--grpcURL zetacore_node:9090")
	StressCmd.Flags().StringVar(&stressTestArgs.zevmURL, "zevmURL", "http://zetacore_node:8545", "--zevmURL http://zetacore_node:8545")
