...
zetacored tx gov submit-proposal proposals/proposal_for_failure.json --from $WALLET_NAME --chain-id athens_101-1 --fees 2000000000000000azeta --yes && sleep 10
...
zetacored tx gov submit-proposal proposals/proposal_for_success.json --from $WALLET_NAME --chain-id athens_101-1 --fees 2000000000000000azeta --yes && sleep 10
...
zetacored tx gov submit-proposal proposals/v100.0.0_proposal.json --from $WALLET_NAME --chain-id athens_101-1 --fees 2000000000000000azeta --yes && sleep 10
...
zetacored tx gov submit-proposal proposals/proposal_voting_period.json --from $WALLET_NAME --chain-id athens_101-1 --fees 2000000000000000azeta --yes && sleep 10
...
zetacored tx gov submit-proposal proposals/proposal_for_deposit.json --from $WALLET_NAME --chain-id athens_101-1 --fees 2000000000000000azeta --yes && sleep 10
