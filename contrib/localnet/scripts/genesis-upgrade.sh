...
# Start of genesis creation . This is done only on $DISCOVERED_NETWORK-zetacore-1
if [ $DISCOVERED_HOSTNAME == "$DISCOVERED_NETWORK-zetacore-1" ]
then
...
# 1. Accumulate all the os_info files from other nodes on $DISCOVERED_NETWORK-zetacore-1 and create a genesis.json
