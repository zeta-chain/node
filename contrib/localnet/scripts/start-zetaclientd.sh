...
then
    ...
    zetaclientd init --val val --log-console --enable-chains "goerli_localnet,btc_regtest" \
      ...
      --chain-id athens_101-1 --dev --operator zeta1z46tdw75jvh4h39y3vu758ctv34rw5z9kmyhgz --log-level 0 --keygen-block 20
    zetaclientd start
else
  num=$(echo $HOSTNAME | tr -dc '0-9')
  node="zetacore$num"
  ...
  zetaclientd init --val val --log-console --enable-chains "goerli_localnet,btc_regtest"  \
    ...
    --chain-id athens_101-1 --dev --operator zeta1lz2fqwzjnk6qy48fgj753h48444fxtt7hekp52 --log-level 0 --keygen-block 20
  zetaclientd start
fi
