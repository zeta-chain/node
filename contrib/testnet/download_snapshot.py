...
def main():
    ...
    # Fetch snapshot info
    print("\n[1/4] Fetching snapshot information...")
    try:
    ...
    # Download snapshot
    print(f"\n[2/4] Downloading snapshot to {snapshot_path}...")
    print("This may take a while depending on your internet connection...")
    run_command(f'curl "{snapshot_link}" -o "{snapshot_path}"')
    print("Download complete!")

    # Create temp directory and extract
    print(f"\n[3/4] Extracting snapshot to temporary location...")
    ...
    print(f"\n[4/4] Moving snapshot data to cache location...")
