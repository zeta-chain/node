...
require (
	...
	github.com/zeta-chain/protocol-contracts v0.0.0-20250904191904-9746a6ff3727
...
replace (
	...
	github.com/cosmos/evm => github.com/zeta-chain/evm v0.0.0-20250813215902-be548f769187
