...
// TestSuiTokenWithdrawAndCallLegacy tests legacy fungible token withdraw and call
func TestSuiTokenWithdrawAndCallLegacy(r *runner.E2ERunner, args []string) {
	...
	payloadOnCall, err := r.SuiCreateExampleWACPayloadLegacy(suiAddress)
