...
// TestSuiWithdrawAndAuthenticatedCallRevertWithCall executes withdrawAndCall on zevm gateway with SUI token.
...
func TestSuiWithdrawAndAuthenticatedCallRevertWithCall(r *runner.E2ERunner, args []string) {
