...
// TestSuiTokenAuthenticatedCallRevertWithCall executes withdrawAndCall on zevm gateway with fungible token.
...
func TestSuiTokenAuthenticatedCallRevertWithCall(r *runner.E2ERunner, args []string) {
