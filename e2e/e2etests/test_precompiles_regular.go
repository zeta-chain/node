...
func TestPrecompilesRegular(r *runner.E2ERunner, args []string) {
	...
	require.NoError(r, err, "Failed to create RegularCaller")
	...
	require.Equal(r, "zeta1h8duy2dltz9xz0qqhm5wvcnj02upy887fyn43u", res, "Failed to validate Bech32ify function")
	...
	require.Equal(r, "0xB9Dbc229Bf588A613C00BEE8e662727AB8121cfE", addr.String(), "Failed to validate Bech32ToHexAddr function")
}
