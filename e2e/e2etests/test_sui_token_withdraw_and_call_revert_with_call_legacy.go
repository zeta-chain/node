...
// TestSuiTokenWithdrawAndCallRevertWithCallLegacy tests legacy fungible token withdraw and call with revert and call
func TestSuiTokenWithdrawAndCallRevertWithCallLegacy(r *runner.E2ERunner, args []string) {
