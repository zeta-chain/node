...
// TestSuiWithdrawAndCallRevertWithCallLegacy tests legacy withdraw and call with revert and call
func TestSuiWithdrawAndCallRevertWithCallLegacy(r *runner.E2ERunner, args []string) {
	...
	invalidPayloadOnCall, err := r.SuiCreateExampleWACPayloadLegacy(invalidAddress)
