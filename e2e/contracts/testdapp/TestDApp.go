...
func DeployTestDApp(auth *bind.TransactOpts, backend bind.ContractBackend, _connector common.Address, _zetaToken common.Address) (common.Address, *types.Transaction, *TestDApp, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(TestDAppBin), backend, _connector, _zetaToken)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_TestDApp *TestDAppCaller) Zeta(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TestDApp.contract.Call(opts, &out, "zeta")
...
//
// Solidity: function zeta() view returns(address)
func (_TestDApp *TestDAppSession) Zeta() (common.Address, error) {
	return _TestDApp.Contract.Zeta(&_TestDApp.CallOpts)
}

// Zeta is a free data retrieval call binding the contract method 0xe8f9cb3a.
//
// Solidity: function zeta() view returns(address)
func (_TestDApp *TestDAppCallerSession) Zeta() (common.Address, error) {
	return _TestDApp.Contract.Zeta(&_TestDApp.CallOpts)
}
