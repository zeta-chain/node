...
//
// Solidity: event UpdatedSystemContract(address indexed systemContract)
func (_ZRC20 *ZRC20Filterer) FilterUpdatedSystemContract(opts *bind.FilterOpts, systemContract []common.Address) (*ZRC20UpdatedSystemContractIterator, error) {

	var systemContractRule []interface{}
	for _, systemContractItem := range systemContract {
		systemContractRule = append(systemContractRule, systemContractItem)
	}

	logs, sub, err := _ZRC20.contract.FilterLogs(opts, "UpdatedSystemContract", systemContractRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event UpdatedSystemContract(address indexed systemContract)
func (_ZRC20 *ZRC20Filterer) WatchUpdatedSystemContract(opts *bind.WatchOpts, sink chan<- *ZRC20UpdatedSystemContract, systemContract []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZRC20.contract.WatchLogs(opts, "UpdatedSystemContract", systemContractRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
