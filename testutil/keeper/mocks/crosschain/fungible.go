...
func (_m *CrosschainFungibleKeeper) DeployZRC20Contract(ctx types.Context, name string, symbol string, decimals uint8, chainID int64, coinType pkg.CoinType, erc20Contract string, gasLimit *big.Int) (common.Address, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, string, string, uint8, int64, pkg.CoinType, string, *big.Int) (common.Address, error)); ok {
		return rf(ctx, name, symbol, decimals, chainID, coinType, erc20Contract, gasLimit)
	}
	if rf, ok := ret.Get(0).(func(types.Context, string, string, uint8, int64, pkg.CoinType, string, *big.Int) common.Address); ok {
	...
	if rf, ok := ret.Get(1).(func(types.Context, string, string, uint8, int64, pkg.CoinType, string, *big.Int) error); ok {
...
func (_m *CrosschainFungibleKeeper) ZRC20DepositAndCallContract(ctx types.Context, from []byte, to common.Address, amount *big.Int, senderChainID int64, data []byte, coinType pkg.CoinType, asset string) (*evmtypes.MsgEthereumTxResponse, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, []byte, common.Address, *big.Int, int64, []byte, pkg.CoinType, string) (*evmtypes.MsgEthereumTxResponse, bool, error)); ok {
		return rf(ctx, from, to, amount, senderChainID, data, coinType, asset)
	}
	if rf, ok := ret.Get(0).(func(types.Context, []byte, common.Address, *big.Int, int64, []byte, pkg.CoinType, string) *evmtypes.MsgEthereumTxResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(types.Context, []byte, common.Address, *big.Int, int64, []byte, pkg.CoinType, string) bool); ok {
		r1 = rf(ctx, from, to, amount, senderChainID, data, coinType, asset)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(types.Context, []byte, common.Address, *big.Int, int64, []byte, pkg.CoinType, string) error); ok {
