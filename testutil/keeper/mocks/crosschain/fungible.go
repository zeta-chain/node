...
// QueryUniswapv2RouterGetAmountsIn provides a mock function with given fields: ctx, amountOut, outZRC4
func (_m *CrosschainFungibleKeeper) QueryUniswapv2RouterGetAmountsIn(ctx types.Context, amountOut *big.Int, outZRC4 common.Address) (*big.Int, error) {
