...
func (_m *CrosschainObserverKeeper) FindBallot(ctx types.Context, index string, chain *pkg.Chain, observationType observertypes.ObservationType) (observertypes.Ballot, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, string, *pkg.Chain, observertypes.ObservationType) (observertypes.Ballot, bool, error)); ok {
		return rf(ctx, index, chain, observationType)
	}
	if rf, ok := ret.Get(0).(func(types.Context, string, *pkg.Chain, observertypes.ObservationType) observertypes.Ballot); ok {
		r0 = rf(ctx, index, chain, observationType)
	} else {
		r0 = ret.Get(0).(observertypes.Ballot)
	}

	if rf, ok := ret.Get(1).(func(types.Context, string, *pkg.Chain, observertypes.ObservationType) bool); ok {
		r1 = rf(ctx, index, chain, observationType)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(types.Context, string, *pkg.Chain, observertypes.ObservationType) error); ok {
...
func (_m *CrosschainObserverKeeper) GetBlockHeader(ctx types.Context, hash []byte) (pkg.BlockHeader, bool) {
	...
	var r0 pkg.BlockHeader
	var r1 bool
	if rf, ok := ret.Get(0).(func(types.Context, []byte) (pkg.BlockHeader, bool)); ok {
		return rf(ctx, hash)
	}
	if rf, ok := ret.Get(0).(func(types.Context, []byte) pkg.BlockHeader); ok {
		r0 = rf(ctx, hash)
	} else {
		r0 = ret.Get(0).(pkg.BlockHeader)
	}
...
func (_m *CrosschainObserverKeeper) GetSupportedChainFromChainID(ctx types.Context, chainID int64) *pkg.Chain {
	ret := _m.Called(ctx, chainID)
	...
	var r0 *pkg.Chain
	if rf, ok := ret.Get(0).(func(types.Context, int64) *pkg.Chain); ok {
		r0 = rf(ctx, chainID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *CrosschainObserverKeeper) GetSupportedChains(ctx types.Context) []*pkg.Chain {
	ret := _m.Called(ctx)
...
func (_m *CrosschainObserverKeeper) VoteOnInboundBallot(ctx types.Context, senderChainID int64, receiverChainID int64, coinType pkg.CoinType, voter string, ballotIndex string, inTxHash string) (bool, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, int64, int64, pkg.CoinType, string, string, string) (bool, bool, error)); ok {
		return rf(ctx, senderChainID, receiverChainID, coinType, voter, ballotIndex, inTxHash)
	}
	if rf, ok := ret.Get(0).(func(types.Context, int64, int64, pkg.CoinType, string, string, string) bool); ok {
		r0 = rf(ctx, senderChainID, receiverChainID, coinType, voter, ballotIndex, inTxHash)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(types.Context, int64, int64, pkg.CoinType, string, string, string) bool); ok {
		r1 = rf(ctx, senderChainID, receiverChainID, coinType, voter, ballotIndex, inTxHash)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(types.Context, int64, int64, pkg.CoinType, string, string, string) error); ok {
...
func (_m *CrosschainObserverKeeper) VoteOnOutboundBallot(ctx types.Context, ballotIndex string, outTxChainID int64, receiveStatus pkg.ReceiveStatus, voter string) (bool, bool, observertypes.Ballot, string, error) {
	...
	var r3 string
	var r4 error
	if rf, ok := ret.Get(0).(func(types.Context, string, int64, pkg.ReceiveStatus, string) (bool, bool, observertypes.Ballot, string, error)); ok {
		return rf(ctx, ballotIndex, outTxChainID, receiveStatus, voter)
	}
	if rf, ok := ret.Get(0).(func(types.Context, string, int64, pkg.ReceiveStatus, string) bool); ok {
		r0 = rf(ctx, ballotIndex, outTxChainID, receiveStatus, voter)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(types.Context, string, int64, pkg.ReceiveStatus, string) bool); ok {
		r1 = rf(ctx, ballotIndex, outTxChainID, receiveStatus, voter)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(types.Context, string, int64, pkg.ReceiveStatus, string) observertypes.Ballot); ok {
		r2 = rf(ctx, ballotIndex, outTxChainID, receiveStatus, voter)
	} else {
		r2 = ret.Get(2).(observertypes.Ballot)
	}

	if rf, ok := ret.Get(3).(func(types.Context, string, int64, pkg.ReceiveStatus, string) string); ok {
		r3 = rf(ctx, ballotIndex, outTxChainID, receiveStatus, voter)
	} else {
		r3 = ret.Get(3).(string)
	}

	if rf, ok := ret.Get(4).(func(types.Context, string, int64, pkg.ReceiveStatus, string) error); ok {
