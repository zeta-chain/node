...
var WithdrawerMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"bytes\",\"name\":\"recipient\",\"type\":\"bytes\"},{\"internalType\":\"contractIZRC20\",\"name\":\"asset\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"internalType\":\"bytes\",\"name\":\"message\",\"type\":\"bytes\"},{\"internalType\":\"uint256\",\"name\":\"count\",\"type\":\"uint256\"}],\"name\":\"runWithdraws\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
	Bin: "",
}
...
// RunWithdraws is a paid mutator transaction binding the contract method 0xb870b7fe.
//
// Solidity: function runWithdraws(bytes recipient, address asset, uint256 amount, bytes message, uint256 count) returns()
func (_Withdrawer *WithdrawerTransactor) RunWithdraws(opts *bind.TransactOpts, recipient []byte, asset common.Address, amount *big.Int, message []byte, count *big.Int) (*types.Transaction, error) {
	return _Withdrawer.contract.Transact(opts, "runWithdraws", recipient, asset, amount, message, count)
}

// RunWithdraws is a paid mutator transaction binding the contract method 0xb870b7fe.
//
// Solidity: function runWithdraws(bytes recipient, address asset, uint256 amount, bytes message, uint256 count) returns()
func (_Withdrawer *WithdrawerSession) RunWithdraws(recipient []byte, asset common.Address, amount *big.Int, message []byte, count *big.Int) (*types.Transaction, error) {
	return _Withdrawer.Contract.RunWithdraws(&_Withdrawer.TransactOpts, recipient, asset, amount, message, count)
}

// RunWithdraws is a paid mutator transaction binding the contract method 0xb870b7fe.
//
// Solidity: function runWithdraws(bytes recipient, address asset, uint256 amount, bytes message, uint256 count) returns()
func (_Withdrawer *WithdrawerTransactorSession) RunWithdraws(recipient []byte, asset common.Address, amount *big.Int, message []byte, count *big.Int) (*types.Transaction, error) {
	return _Withdrawer.Contract.RunWithdraws(&_Withdrawer.TransactOpts, recipient, asset, amount, message, count)
}
