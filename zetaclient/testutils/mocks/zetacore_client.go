...
func (_m *ZetacoreClient) NewBlockSubscriber(ctx context.Context) (chan cometbft_types.EventDataNewBlock, error) {
	ret := _m.Called(ctx)

	var r0 chan cometbft_types.EventDataNewBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (chan cometbft_types.EventDataNewBlock, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) chan cometbft_types.EventDataNewBlock); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(chan cometbft_types.EventDataNewBlock)
		}
	}
