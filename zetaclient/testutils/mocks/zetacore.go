...
// GetBaseGasPrice provides a mock function with given fields: ctx
func (_m *ZetacoreClient) GetBaseGasPrice(ctx context.Context) (int64, error) {
	ret := _m.Called(ctx)
...
func (_m *ZetacoreClient) GetChainParams(ctx context.Context) ([]*types.ChainParams, error) {
	ret := _m.Called(ctx)
...
func (_m *ZetacoreClient) GetCrosschainFlags(ctx context.Context) (types.CrosschainFlags, error) {
	ret := _m.Called(ctx)
...
func (_m *ZetacoreClient) GetKeyGen(ctx context.Context) (types.Keygen, error) {
	ret := _m.Called(ctx)
...
// GetNumberOfUnconfirmedTxs provides a mock function with given fields: ctx
func (_m *ZetacoreClient) GetNumberOfUnconfirmedTxs(ctx context.Context) (int, error) {
	ret := _m.Called(ctx)
...
func (_m *ZetacoreClient) GetOperationalFlags(ctx context.Context) (types.OperationalFlags, error) {
	ret := _m.Called(ctx)
...
// HasVoted provides a mock function with given fields: _a0, ballotIndex, voterAddress
func (_m *ZetacoreClient) HasVoted(_a0 context.Context, ballotIndex string, voterAddress string) (bool, error) {
	ret := _m.Called(_a0, ballotIndex, voterAddress)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (bool, error)); ok {
		return rf(_a0, ballotIndex, voterAddress)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) bool); ok {
		r0 = rf(_a0, ballotIndex, voterAddress)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(_a0, ballotIndex, voterAddress)
	} else {
		r1 = ret.Error(1)
	}
...
// PostVoteGasPrice provides a mock function with given fields: _a0, _a1, gasPrice, priorityFee, block
func (_m *ZetacoreClient) PostVoteGasPrice(_a0 context.Context, _a1 chains.Chain, gasPrice uint64, priorityFee uint64, block uint64) (string, error) {
	ret := _m.Called(_a0, _a1, gasPrice, priorityFee, block)
