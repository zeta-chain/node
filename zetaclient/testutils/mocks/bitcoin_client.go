...
func (_m *BitcoinClient) CreateRawTransaction(ctx context.Context, inputs []btcjson.TransactionInput, amounts map[btcutil.Address]btcutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
	ret := _m.Called(ctx, inputs, amounts, lockTime)
	...
	var r0 *wire.MsgTx
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []btcjson.TransactionInput, map[btcutil.Address]btcutil.Amount, *int64) (*wire.MsgTx, error)); ok {
		return rf(ctx, inputs, amounts, lockTime)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []btcjson.TransactionInput, map[btcutil.Address]btcutil.Amount, *int64) *wire.MsgTx); ok {
		r0 = rf(ctx, inputs, amounts, lockTime)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []btcjson.TransactionInput, map[btcutil.Address]btcutil.Amount, *int64) error); ok {
		r1 = rf(ctx, inputs, amounts, lockTime)
	} else {
		r1 = ret.Error(1)
	}
...
// GetEstimatedFeeRate provides a mock function with given fields: ctx, confTarget, regnet
func (_m *BitcoinClient) GetEstimatedFeeRate(ctx context.Context, confTarget int64, regnet bool) (int64, error) {
	ret := _m.Called(ctx, confTarget, regnet)
...
func (_m *BitcoinClient) ImportPrivKeyRescan(ctx context.Context, privKeyWIF *btcutil.WIF, label string, rescan bool) error {
	ret := _m.Called(ctx, privKeyWIF, label, rescan)

	if len(ret) == 0 {
		panic("no return value specified for ImportPrivKeyRescan")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *btcutil.WIF, string, bool) error); ok {
...
func (_m *BitcoinClient) SignRawTransactionWithWallet2(ctx context.Context, tx *wire.MsgTx, inputs []btcjson.RawTxWitnessInput) (*wire.MsgTx, bool, error) {
	ret := _m.Called(ctx, tx, inputs)

	if len(ret) == 0 {
		panic("no return value specified for SignRawTransactionWithWallet2")
	}

	var r0 *wire.MsgTx
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *wire.MsgTx, []btcjson.RawTxWitnessInput) (*wire.MsgTx, bool, error)); ok {
		return rf(ctx, tx, inputs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *wire.MsgTx, []btcjson.RawTxWitnessInput) *wire.MsgTx); ok {
		r0 = rf(ctx, tx, inputs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*wire.MsgTx)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *wire.MsgTx, []btcjson.RawTxWitnessInput) bool); ok {
		r1 = rf(ctx, tx, inputs)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(context.Context, *wire.MsgTx, []btcjson.RawTxWitnessInput) error); ok {
		r2 = rf(ctx, tx, inputs)
	} else {
		r2 = ret.Error(2)
	}
