...
func FileNameEVMIntx(chainID int64, intxHash string, coinType pkg.CoinType, donation bool) string {
	if !donation {
...
func FileNameEVMIntxReceipt(chainID int64, intxHash string, coinType pkg.CoinType, donation bool) string {
	if !donation {
...
func FileNameEVMIntxCctx(chainID int64, intxHash string, coinType pkg.CoinType) string {
...
func FileNameEVMOuttx(chainID int64, txHash string, coinType pkg.CoinType) string {
...
func FileNameEVMOuttxReceipt(chainID int64, txHash string, coinType pkg.CoinType) string {
