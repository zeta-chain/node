...
func LoadEVMIntx(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) *ethrpc.Transaction {
...
func LoadEVMIntxReceipt(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) *ethtypes.Receipt {
...
func LoadEVMIntxCctx(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) *crosschaintypes.CrossChainTx {
...
func LoadEVMIntxNReceipt(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) (*ethrpc.Transaction, *ethtypes.Receipt) {
...
func LoadEVMIntxNReceiptNCctx(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) (*ethrpc.Transaction, *ethtypes.Receipt, *crosschaintypes.CrossChainTx) {
...
func LoadEVMOuttx(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) *ethtypes.Transaction {
...
func LoadEVMOuttxNReceipt(
	...
	chainID int64,
	intxHash string,
	coinType pkg.CoinType) (*ethtypes.Transaction, *ethtypes.Receipt) {
