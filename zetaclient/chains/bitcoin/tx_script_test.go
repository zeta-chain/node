...
func TestDecodeVoutP2TR(t *testing.T) {
	...
	// decode vout 0, P2TR
	receiver, err := bitcoin.DecodeScriptP2TR(rawResult.Vout[0].ScriptPubKey.Hex, net)
...
func TestDecodeVoutP2TRErrors(t *testing.T) {
	...
	t.Run("should return error on invalid script", func(t *testing.T) {
		...
		_, err := bitcoin.DecodeScriptP2TR(invalidVout.ScriptPubKey.Hex, net)
...
func TestDecodeVoutP2WSH(t *testing.T) {
	...
	// decode vout 0, P2WSH
	receiver, err := bitcoin.DecodeScriptP2WSH(rawResult.Vout[0].ScriptPubKey.Hex, net)
	require.NoError(t, err)
...
func TestDecodeVoutP2WSHErrors(t *testing.T) {
	...
	t.Run("should return error on invalid script", func(t *testing.T) {
		invalidVout := rawResult.Vout[0]
		invalidVout.ScriptPubKey.Hex = "invalid script"
		_, err := bitcoin.DecodeScriptP2WSH(invalidVout.ScriptPubKey.Hex, net)
		require.ErrorContains(t, err, "error decoding script")
	})
...
func TestDecodeP2WPKHVout(t *testing.T) {
	...
	receiver, err := bitcoin.DecodeScriptP2WPKH(rawResult.Vout[0].ScriptPubKey.Hex, net)
	require.NoError(t, err)
	require.Equal(t, testutils.TSSAddressBTCMainnet, receiver)

	// decode vout 1, payment 0.00012000 BTC
	receiver, err = bitcoin.DecodeScriptP2WPKH(rawResult.Vout[1].ScriptPubKey.Hex, net)
	require.NoError(t, err)
	require.Equal(t, "bc1qpsdlklfcmlcfgm77c43x65ddtrt7n0z57hsyjp", receiver)

	// decode vout 2, change 0.39041489 BTC
	receiver, err = bitcoin.DecodeScriptP2WPKH(rawResult.Vout[2].ScriptPubKey.Hex, net)
	require.NoError(t, err)
	require.Equal(t, testutils.TSSAddressBTCMainnet, receiver)
}
...
func TestDecodeP2WPKHVoutErrors(t *testing.T) {
	...
	t.Run("should return error on invalid script", func(t *testing.T) {
		invalidVout := rawResult.Vout[0]
		invalidVout.ScriptPubKey.Hex = "invalid script"
		_, err := bitcoin.DecodeScriptP2WPKH(invalidVout.ScriptPubKey.Hex, net)
		require.ErrorContains(t, err, "error decoding script")
	})
...
func TestDecodeVoutP2SH(t *testing.T) {
	...
	// decode vout 0, P2SH
	receiver, err := bitcoin.DecodeScriptP2SH(rawResult.Vout[0].ScriptPubKey.Hex, net)
	require.NoError(t, err)
...
func TestDecodeVoutP2SHErrors(t *testing.T) {
	...
	t.Run("should return error on invalid script", func(t *testing.T) {
		invalidVout := rawResult.Vout[0]
		invalidVout.ScriptPubKey.Hex = "invalid script"
		_, err := bitcoin.DecodeScriptP2SH(invalidVout.ScriptPubKey.Hex, net)
		require.ErrorContains(t, err, "error decoding script")
	})
...
func TestDecodeVoutP2PKH(t *testing.T) {
	...
	// decode vout 0, P2PKH
	receiver, err := bitcoin.DecodeScriptP2PKH(rawResult.Vout[0].ScriptPubKey.Hex, net)
	require.NoError(t, err)
...
func TestDecodeVoutP2PKHErrors(t *testing.T) {
	...
	t.Run("should return error on invalid script", func(t *testing.T) {
		invalidVout := rawResult.Vout[0]
		invalidVout.ScriptPubKey.Hex = "invalid script"
		_, err := bitcoin.DecodeScriptP2PKH(invalidVout.ScriptPubKey.Hex, net)
		require.ErrorContains(t, err, "error decoding script")
	})
...
func TestDecodeSenderFromScript(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			sender, err := bitcoin.DecodeSenderFromScript(pkScript, net)
...
func TestDecodeTSSVout(t *testing.T) {
	...
	t.Run("should decode P2TR vout", func(t *testing.T) {
		...
		receiver, amount, err := bitcoin.DecodeTSSVout(rawResult.Vout[0], receiverExpected, chain)
		require.NoError(t, err)
...
func TestDecodeTSSVoutErrors(t *testing.T) {
	...
	t.Run("should return error on invalid amount", func(t *testing.T) {
		...
		receiver, amount, err := bitcoin.DecodeTSSVout(invalidVout, receiverExpected, chain)
	...
	t.Run("should return error on invalid btc chain", func(t *testing.T) {
		...
		receiver, amount, err := bitcoin.DecodeTSSVout(invalidVout, receiverExpected, invalidChain)
	...
	t.Run("should return error when invalid receiver passed", func(t *testing.T) {
		...
		receiver, amount, err := bitcoin.DecodeTSSVout(
			invalidVout,
