...
func Test_CheckAndVoteInboundTokenZeta(t *testing.T) {
	...
	t.Run("should pass for archived intx, receipt and cctx", func(t *testing.T) {
		tx, receipt, cctx := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_Zeta)
	...
	t.Run("should fail on unconfirmed intx", func(t *testing.T) {
		tx, receipt, _ := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_Zeta)
		require.NoError(t, evm.ValidateEvmTransaction(tx))
...
func Test_CheckAndVoteInboundTokenERC20(t *testing.T) {
	...
	t.Run("should pass for archived intx, receipt and cctx", func(t *testing.T) {
		tx, receipt, cctx := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_ERC20)
		require.NoError(t, evm.ValidateEvmTransaction(tx))
		lastBlock := receipt.BlockNumber.Uint64() + confirmation
	...
	t.Run("should fail on unconfirmed intx", func(t *testing.T) {
		tx, receipt, _ := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_ERC20)
		require.NoError(t, evm.ValidateEvmTransaction(tx))
		lastBlock := receipt.BlockNumber.Uint64() + confirmation - 1
...
func Test_CheckAndVoteInboundTokenGas(t *testing.T) {
	...
	t.Run("should pass for archived intx, receipt and cctx", func(t *testing.T) {
		tx, receipt, cctx := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_Gas)
		require.NoError(t, evm.ValidateEvmTransaction(tx))
		lastBlock := receipt.BlockNumber.Uint64() + confirmation
	...
	t.Run("should fail on unconfirmed intx", func(t *testing.T) {
		tx, receipt, _ := testutils.LoadEVMInboundNReceiptNCctx(t, TestDataDir, chainID, intxHash, coin.CoinType_Gas)
		require.NoError(t, evm.ValidateEvmTransaction(tx))
		lastBlock := receipt.BlockNumber.Uint64() + confirmation - 1
...
func Test_BuildInboundVoteMsgForZetaSentEvent(t *testing.T) {
	...
	chain := chains.EthChain
	intxHash := "0xf3935200c80f98502d5edc7e871ffc40ca898e134525c42c2ae3cbc5725f9d76"
	receipt := testutils.LoadEVMInboundReceipt(t, TestDataDir, chainID, intxHash, coin.CoinType_Zeta)
	cctx := testutils.LoadCctxByInbound(t, chainID, coin.CoinType_Zeta, intxHash)
...
func Test_BuildInboundVoteMsgForDepositedEvent(t *testing.T) {
	...
	chainID := chain.ChainId
	intxHash := "0x4ea69a0e2ff36f7548ab75791c3b990e076e2a4bffeb616035b239b7d33843da"
	tx, receipt := testutils.LoadEVMInboundNReceipt(t, TestDataDir, chainID, intxHash, coin.CoinType_ERC20)
	cctx := testutils.LoadCctxByInbound(t, chainID, coin.CoinType_ERC20, intxHash)
...
func Test_BuildInboundVoteMsgForTokenSentToTSS(t *testing.T) {
	...
	chainID := chain.ChainId
	intxHash := "0xeaec67d5dd5d85f27b21bef83e01cbdf59154fd793ea7a22c297f7c3a722c532"
	tx, receipt := testutils.LoadEVMInboundNReceipt(t, TestDataDir, chainID, intxHash, coin.CoinType_Gas)
	require.NoError(t, evm.ValidateEvmTransaction(tx))
	cctx := testutils.LoadCctxByInbound(t, chainID, coin.CoinType_Gas, intxHash)
