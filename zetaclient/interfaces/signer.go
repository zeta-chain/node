...
type TSSSigner interface {
	...
	Sign(data []byte, height uint64, nonce uint64, chain *pkg.Chain, optionalPubkey string) ([65]byte, error)
...
func (s TestSigner) Sign(digest []byte, _ uint64, _ uint64, _ *pkg.Chain, _ string) ([65]byte, error) {
