 ...
 * Deprecated(v30)
 *
 * @generated from message zetachain.zetacore.observer.LegacyChainParams
 */
export declare class LegacyChainParams extends Message<LegacyChainParams> {
  /**
   * @generated from field: int64 chain_id = 11;
   */
  chainId: bigint;
  ...
  constructor(data?: PartialMessage<LegacyChainParams>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.observer.LegacyChainParams";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LegacyChainParams;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LegacyChainParams;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LegacyChainParams;

  static equals(a: LegacyChainParams | PlainMessage<LegacyChainParams> | undefined, b: LegacyChainParams | PlainMessage<LegacyChainParams> | undefined): boolean;
}
