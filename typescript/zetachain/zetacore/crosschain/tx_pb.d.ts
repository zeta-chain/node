...
/**
 * @generated from message zetachain.zetacore.crosschain.MsgMigrateConnectorFunds
 */
export declare class MsgMigrateConnectorFunds extends Message<MsgMigrateConnectorFunds> {
  /**
   * @generated from field: string creator = 1;
   */
  creator: string;
  ...
  /**
   * @generated from field: string new_connector_address = 3;
   */
  ...
  constructor(data?: PartialMessage<MsgMigrateConnectorFunds>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgMigrateConnectorFunds";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MsgMigrateConnectorFunds;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgMigrateConnectorFunds;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgMigrateConnectorFunds;

  static equals(a: MsgMigrateConnectorFunds | PlainMessage<MsgMigrateConnectorFunds> | undefined, b: MsgMigrateConnectorFunds | PlainMessage<MsgMigrateConnectorFunds> | undefined): boolean;
}

/**
 * @generated from message zetachain.zetacore.crosschain.MsgMigrateConnectorFundsResponse
 */
export declare class MsgMigrateConnectorFundsResponse extends Message<MsgMigrateConnectorFundsResponse> {
  /**
   * @generated from field: string cctx_index = 1;
   */
  cctxIndex: string;

  constructor(data?: PartialMessage<MsgMigrateConnectorFundsResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgMigrateConnectorFundsResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MsgMigrateConnectorFundsResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MsgMigrateConnectorFundsResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MsgMigrateConnectorFundsResponse;

  static equals(a: MsgMigrateConnectorFundsResponse | PlainMessage<MsgMigrateConnectorFundsResponse> | undefined, b: MsgMigrateConnectorFundsResponse | PlainMessage<MsgMigrateConnectorFundsResponse> | undefined): boolean;
}
