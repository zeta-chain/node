...
export declare class MsgUpdatePermissionFlags extends Message<MsgUpdatePermissionFlags> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgUpdatePermissionFlags";
  static readonly fields: FieldList;
...
export declare class MsgUpdatePermissionFlagsResponse extends Message<MsgUpdatePermissionFlagsResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgUpdatePermissionFlagsResponse";
  static readonly fields: FieldList;
...
export declare class MsgUpdateKeygen extends Message<MsgUpdateKeygen> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgUpdateKeygen";
  static readonly fields: FieldList;
...
export declare class MsgUpdateKeygenResponse extends Message<MsgUpdateKeygenResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "zetachain.zetacore.crosschain.MsgUpdateKeygenResponse";
  static readonly fields: FieldList;
