...
func (k Keeper) HandleEVMDeposit(
	...
	if msg.CoinType == pkg.CoinType_Zeta {
		...
		parsedAddress, data, err := pkg.ParseAddressAndData(msg.Message)
		if err != nil {
		...
		from, err := pkg.DecodeAddressFromChainID(senderChainID, msg.Sender)
		if err != nil {
