...
func (k Keeper) parseZetaInbound(ctx sdk.Context, receiverChainID *big.Int, callOptions gatewayzevm.CallOptions, wzetaContractAddress string) (InboundDetails, error) {
