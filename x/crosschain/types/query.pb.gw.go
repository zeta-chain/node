...
var (
	...
	pattern_Query_ZetaAccounting_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta-chain", "crosschain", "abortedZetaAmount"}, "", runtime.AssumeColonVerbOpt(false)))
)
