...
type IsFinalized int32

const (
	IsFinalized_NotFinalized IsFinalized = 0
	IsFinalized_Finalized    IsFinalized = 1
	IsFinalized_Executed     IsFinalized = 2
)

var IsFinalized_name = map[int32]string{
	0: "NotFinalized",
	1: "Finalized",
	2: "Executed",
}

var IsFinalized_value = map[string]int32{
	"NotFinalized": 0,
	"Finalized":    1,
	"Executed":     2,
}

func (x IsFinalized) String() string {
	return proto.EnumName(IsFinalized_name, int32(x))
}

func (IsFinalized) EnumDescriptor() ([]byte, []int) {
...
type InboundTxParams struct {
	...
	InboundTxIsFinalized            IsFinalized                             `protobuf:"varint,11,opt,name=inbound_tx_is_finalized,json=inboundTxIsFinalized,proto3,enum=zetachain.zetacore.crosschain.IsFinalized" json:"inbound_tx_is_finalized,omitempty"`
}
...
func (m *InboundTxParams) GetInboundTxIsFinalized() IsFinalized {
	if m != nil {
		return m.InboundTxIsFinalized
	}
	return IsFinalized_NotFinalized
}
...
type OutboundTxParams struct {
	...
	OutboundTxIsFinalized            IsFinalized                            `protobuf:"varint,12,opt,name=outbound_tx_is_finalized,json=outboundTxIsFinalized,proto3,enum=zetachain.zetacore.crosschain.IsFinalized" json:"outbound_tx_is_finalized,omitempty"`
}
...
func (m *OutboundTxParams) GetOutboundTxIsFinalized() IsFinalized {
	if m != nil {
		return m.OutboundTxIsFinalized
	}
	return IsFinalized_NotFinalized
}
...
func init() {
	...
	proto.RegisterEnum("zetachain.zetacore.crosschain.IsFinalized", IsFinalized_name, IsFinalized_value)
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
...
func (m *InboundTxParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.InboundTxIsFinalized != 0 {
		i = encodeVarintCrossChainTx(dAtA, i, uint64(m.InboundTxIsFinalized))
		i--
		dAtA[i] = 0x58
	}
...
func (m *OutboundTxParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OutboundTxIsFinalized != 0 {
		i = encodeVarintCrossChainTx(dAtA, i, uint64(m.OutboundTxIsFinalized))
		i--
		dAtA[i] = 0x60
	}
...
func (m *InboundTxParams) Size() (n int) {
	...
	if m.InboundTxIsFinalized != 0 {
		n += 1 + sovCrossChainTx(uint64(m.InboundTxIsFinalized))
	}
	return n
}
...
func (m *OutboundTxParams) Size() (n int) {
	...
	if m.OutboundTxIsFinalized != 0 {
		n += 1 + sovCrossChainTx(uint64(m.OutboundTxIsFinalized))
	}
	if m.OutboundTxGasUsed != 0 {
...
func (m *InboundTxParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InboundTxIsFinalized", wireType)
			}
			m.InboundTxIsFinalized = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCrossChainTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InboundTxIsFinalized |= IsFinalized(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *OutboundTxParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutboundTxIsFinalized", wireType)
			}
			m.OutboundTxIsFinalized = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCrossChainTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OutboundTxIsFinalized |= IsFinalized(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
