...
type AbortedZetaAmount struct {
	Amount github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,6,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"amount"`
}

func (m *AbortedZetaAmount) Reset()         { *m = AbortedZetaAmount{} }
func (m *AbortedZetaAmount) String() string { return proto.CompactTextString(m) }
func (*AbortedZetaAmount) ProtoMessage()    {}
func (*AbortedZetaAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_af3a0ad055343c21, []int{1}
}
func (m *AbortedZetaAmount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AbortedZetaAmount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AbortedZetaAmount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AbortedZetaAmount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AbortedZetaAmount.Merge(m, src)
}
func (m *AbortedZetaAmount) XXX_Size() int {
	return m.Size()
}
func (m *AbortedZetaAmount) XXX_DiscardUnknown() {
	xxx_messageInfo_AbortedZetaAmount.DiscardUnknown(m)
}

var xxx_messageInfo_AbortedZetaAmount proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AbortedZetaAmount)(nil), "zetachain.zetacore.crosschain.AbortedZetaAmount")
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
...
func (m *AbortedZetaAmount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AbortedZetaAmount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AbortedZetaAmount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AbortedZetaAmount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AbortedZetaAmount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AbortedZetaAmount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AbortedZetaAmount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 6:
			if wireType != 2 {
