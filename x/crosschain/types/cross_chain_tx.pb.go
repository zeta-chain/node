...
const (
	...
	CctxStatus_Aborted_Refundable    CctxStatus = 6
	CctxStatus_Aborted_NonRefundable CctxStatus = 7
)
...
var CctxStatus_name = map[int32]string{
	...
	4: "PendingRevert",
	5: "Reverted",
	6: "Aborted_Refundable",
	7: "Aborted_NonRefundable",
}
...
var CctxStatus_value = map[string]int32{
	...
	"PendingRevert":         4,
	"Reverted":              5,
	"Aborted_Refundable":    6,
	"Aborted_NonRefundable": 7,
}
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
