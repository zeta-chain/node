...
type InboundTxParams struct {
	...
	TxFinalizationStatus            TxFinalizationStatus                    `protobuf:"varint,11,opt,name=tx_finalization_status,json=txFinalizationStatus,proto3,enum=crosschain.TxFinalizationStatus" json:"tx_finalization_status,omitempty"`
}
...
func (m *InboundTxParams) GetCoinType() coin.CoinType {
	if m != nil {
		return m.CoinType
	}
...
type OutboundTxParams struct {
	...
	CoinType           coin.CoinType                           `protobuf:"varint,3,opt,name=coin_type,json=coinType,proto3,enum=pkg.coin.CoinType" json:"coin_type,omitempty"`
	...
	TxFinalizationStatus             TxFinalizationStatus                   `protobuf:"varint,12,opt,name=tx_finalization_status,json=txFinalizationStatus,proto3,enum=crosschain.TxFinalizationStatus" json:"tx_finalization_status,omitempty"`
}
...
func (m *OutboundTxParams) GetCoinType() coin.CoinType {
	if m != nil {
		return m.CoinType
	}
	return coin.CoinType_Zeta
...
type Status struct {
	Status              CctxStatus `protobuf:"varint,1,opt,name=status,proto3,enum=crosschain.CctxStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("crosschain.CctxStatus", CctxStatus_name, CctxStatus_value)
	proto.RegisterEnum("crosschain.TxFinalizationStatus", TxFinalizationStatus_name, TxFinalizationStatus_value)
	proto.RegisterType((*InboundTxParams)(nil), "crosschain.InboundTxParams")
	proto.RegisterType((*ZetaAccounting)(nil), "crosschain.ZetaAccounting")
	proto.RegisterType((*OutboundTxParams)(nil), "crosschain.OutboundTxParams")
	proto.RegisterType((*Status)(nil), "crosschain.Status")
	proto.RegisterType((*CrossChainTx)(nil), "crosschain.CrossChainTx")
}
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
