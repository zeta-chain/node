...
type CctxPendingQueue struct {
	Index     string `protobuf:"bytes,1,opt,name=index,proto3" json:"index,omitempty"`
	Chain     string `protobuf:"bytes,2,opt,name=chain,proto3" json:"chain,omitempty"`
	Nonce     uint64 `protobuf:"varint,3,opt,name=nonce,proto3" json:"nonce,omitempty"`
	CctxIndex string `protobuf:"bytes,4,opt,name=cctxIndex,proto3" json:"cctxIndex,omitempty"`
}

func (m *CctxPendingQueue) Reset()         { *m = CctxPendingQueue{} }
func (m *CctxPendingQueue) String() string { return proto.CompactTextString(m) }
func (*CctxPendingQueue) ProtoMessage()    {}
func (*CctxPendingQueue) Descriptor() ([]byte, []int) {
	return fileDescriptor_af3a0ad055343c21, []int{4}
}
func (m *CctxPendingQueue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CctxPendingQueue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CctxPendingQueue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CctxPendingQueue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CctxPendingQueue.Merge(m, src)
}
func (m *CctxPendingQueue) XXX_Size() int {
	return m.Size()
}
func (m *CctxPendingQueue) XXX_DiscardUnknown() {
	xxx_messageInfo_CctxPendingQueue.DiscardUnknown(m)
}

var xxx_messageInfo_CctxPendingQueue proto.InternalMessageInfo

func (m *CctxPendingQueue) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *CctxPendingQueue) GetChain() string {
	if m != nil {
		return m.Chain
	}
	return ""
...
func (m *CctxPendingQueue) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *CctxPendingQueue) GetCctxIndex() string {
	if m != nil {
		return m.CctxIndex
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*CctxPendingQueue)(nil), "zetachain.zetacore.crosschain.CctxPendingQueue")
}
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
...
func (m *CctxPendingQueue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CctxPendingQueue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CctxPendingQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.CctxIndex) > 0 {
		...
		i = encodeVarintCrossChainTx(dAtA, i, uint64(len(m.CctxIndex)))
		i--
		dAtA[i] = 0x22
	}
	if m.Nonce != 0 {
		i = encodeVarintCrossChainTx(dAtA, i, uint64(m.Nonce))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Chain) > 0 {
		i -= len(m.Chain)
		copy(dAtA[i:], m.Chain)
		i = encodeVarintCrossChainTx(dAtA, i, uint64(len(m.Chain)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
...
func (m *CctxPendingQueue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Nonce != 0 {
		n += 1 + sovCrossChainTx(uint64(m.Nonce))
	}
	l = len(m.CctxIndex)
	if l > 0 {
		n += 1 + l + sovCrossChainTx(uint64(l))
...
func (m *CctxPendingQueue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CctxPendingQueue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CctxPendingQueue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
