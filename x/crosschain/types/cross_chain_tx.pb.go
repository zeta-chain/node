...
func (m *InboundTxParams) GetCoinType() proto1.CoinType {
	if m != nil {
		return m.CoinType
	}
...
func (m *OutboundTxParams) GetCoinType() proto1.CoinType {
	if m != nil {
		return m.CoinType
	}
	return proto1.CoinType_Zeta
...
var fileDescriptor_af3a0ad055343c21 = []byte{
	...
	,
}
