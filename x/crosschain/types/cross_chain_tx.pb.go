...
const (
	ObservationMode_SAFE ObservationMode = 0
	ObservationMode_FAST ObservationMode = 1
)

var ObservationMode_name = map[int32]string{
	0: "SAFE",
	1: "FAST",
}

var ObservationMode_value = map[string]int32{
	"SAFE": 0,
	"FAST": 1,
}

func (x ObservationMode) String() string {
	return proto.EnumName(ObservationMode_name, int32(x))
}
...
func (m *InboundParams) GetObservationMode() ObservationMode {
	if m != nil {
...
type OutboundParams struct {
	...
	ObservationMode ObservationMode `protobuf:"varint,25,opt,name=observation_mode,json=observationMode,proto3,enum=zetachain.zetacore.crosschain.ObservationMode" json:"observation_mode,omitempty"`
}
...
func (m *OutboundParams) GetObservationMode() ObservationMode {
	if m != nil {
		return m.ObservationMode
	}
	return ObservationMode_SAFE
...
func init() {
	...
	proto.RegisterEnum("zetachain.zetacore.crosschain.ObservationMode", ObservationMode_name, ObservationMode_value)
...
var fileDescriptor_d4c1966807fb5cb2 = []byte{
	...
	,
}
...
func (m *InboundParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ObservationMode != 0 {
		i = encodeVarintCrossChainTx(dAtA, i, uint64(m.ObservationMode))
		i--
		dAtA[i] = 0x68
	}
...
func (m *InboundParams) Size() (n int) {
	...
	if m.ObservationMode != 0 {
		n += 1 + sovCrossChainTx(uint64(m.ObservationMode))
	}
	if m.Status != 0 {
...
func (m *OutboundParams) Size() (n int) {
	...
	if m.ObservationMode != 0 {
		n += 2 + sovCrossChainTx(uint64(m.ObservationMode))
	}
	return n
}
