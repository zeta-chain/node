...
func (m *ChainNonces) GetChain() int64 {
	if m != nil {
		return m.Chain
	}
	return 0
...
var fileDescriptor_c2dddd7805d88f2e = []byte{
	...
	,
}
...
func (m *ChainNonces) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Chain != 0 {
		i = encodeVarintChainNonces(dAtA, i, uint64(m.Chain))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Index) > 0 {
...
func (m *ChainNonces) Size() (n int) {
	...
	if m.Chain != 0 {
		n += 1 + sovChainNonces(uint64(m.Chain))
	}
	if m.Nonce != 0 {
