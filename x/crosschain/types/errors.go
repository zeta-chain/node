...
var (
	...
	ErrKeygenCompleted          = sdkerrors.Register(ModuleName, 1128, "Keygen already completed")
	ErrInvalidTxParams          = sdkerrors.Register(ModuleName, 1129, "Err invalid tx params")
)
