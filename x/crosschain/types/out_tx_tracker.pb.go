...
func (m *OutTxTracker) GetChain() int64 {
	if m != nil {
		return m.Chain
	}
	return 0
...
var fileDescriptor_5638c11005e4d36d = []byte{
	...
	0x38, 0x20, 0x51, 0xb0, 0x6d, 0x60, 0xdd, 0xcc, 0x41, 0x10, 0x0e, 0x48, 0x34, 0x2f, 0x3f, 0x2f,
	0x39, 0x55, 0x82, 0x19, 0xa2, 0x16, 0xcc, 0x11, 0x72, 0xe5, 0xe2, 0xc8, 0x80, 0x3a, 0x47, 0x82,
	0x45, 0x81, 0x59, 0x83, 0xdb, 0x48, 0x53, 0x0f, 0xaf, 0x17, 0xf4, 0x10, 0xee, 0x0f, 0x82, 0x6b,
	0x75, 0xf2, 0x3e, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27,
	0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0xc3, 0xf4, 0xcc,
	0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x90, 0x71, 0xba, 0x90, 0xc0, 0x83, 0x99,
	0xac, 0x5f, 0xa1, 0x8f, 0x14, 0xa4, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xa0, 0x34,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x51, 0xd4, 0xd0, 0x7a, 0x6d, 0x01, 0x00, 0x00,
}
...
func (m *OutTxTracker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Chain != 0 {
		i = encodeVarintOutTxTracker(dAtA, i, uint64(m.Chain))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Index) > 0 {
...
func (m *OutTxTracker) Size() (n int) {
	...
	if m.Chain != 0 {
		n += 1 + sovOutTxTracker(uint64(m.Chain))
	}
	l = len(m.Nonce)
	if l > 0 {
		n += 1 + l + sovOutTxTracker(uint64(l))
