...
type ObserverKeeper interface {
	...
	FindBallot(ctx sdk.Context, index string, chain *pkg.Chain, observationType observertypes.ObservationType) (ballot observertypes.Ballot, isNew bool, err error)
	AddBallotToList(ctx sdk.Context, ballot observertypes.Ballot)
	GetBlockHeader(ctx sdk.Context, hash []byte) (val pkg.BlockHeader, found bool)
	...
	GetSupportedChainFromChainID(ctx sdk.Context, chainID int64) *pkg.Chain
	GetSupportedChains(ctx sdk.Context) []*pkg.Chain
}
