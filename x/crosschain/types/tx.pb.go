...
type MsgCreateTSSVoter struct {
	...
	Status           pkg.ReceiveStatus `protobuf:"varint,4,opt,name=status,proto3,enum=pkg.ReceiveStatus" json:"status,omitempty"`
}
...
func (m *MsgCreateTSSVoter) GetStatus() pkg.ReceiveStatus {
	...
	return pkg.ReceiveStatus_Created
}
...
type MsgAddToInTxTracker struct {
	...
	CoinType  pkg.CoinType `protobuf:"varint,4,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
	Proof     *pkg.Proof   `protobuf:"bytes,5,opt,name=proof,proto3" json:"proof,omitempty"`
...
func (m *MsgAddToInTxTracker) GetCoinType() pkg.CoinType {
	if m != nil {
		return m.CoinType
	}
...
func (m *MsgAddToInTxTracker) GetProof() *pkg.Proof {
	if m != nil {
		return m.Proof
	}
	return nil
...
func (m *MsgAddToOutTxTracker) GetProof() *pkg.Proof {
	if m != nil {
		return m.Proof
	}
	return nil
...
type MsgVoteOnObservedOutboundTx struct {
	...
	Status                         pkg.ReceiveStatus                       `protobuf:"varint,6,opt,name=status,proto3,enum=pkg.ReceiveStatus" json:"status,omitempty"`
	...
	CoinType                       pkg.CoinType                            `protobuf:"varint,9,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
}
...
func (m *MsgVoteOnObservedOutboundTx) GetCoinType() pkg.CoinType {
	if m != nil {
		return m.CoinType
	}
	return pkg.CoinType_Zeta
...
type MsgVoteOnObservedInboundTx struct {
	...
	CoinType      pkg.CoinType `protobuf:"varint,12,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
...
func (m *MsgVoteOnObservedInboundTx) GetCoinType() pkg.CoinType {
	if m != nil {
		return m.CoinType
	}
	return pkg.CoinType_Zeta
...
var fileDescriptor_81d6d611190b7635 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= pkg.ReceiveStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
