...
type MsgCreateTSSVoter struct {
	...
	Status           proto1.ReceiveStatus `protobuf:"varint,4,opt,name=status,proto3,enum=pkg.ReceiveStatus" json:"status,omitempty"`
}
...
func (m *MsgCreateTSSVoter) GetStatus() proto1.ReceiveStatus {
	if m != nil {
		return m.Status
	}
	return proto1.ReceiveStatus_Created
}
...
type MsgAddToInTxTracker struct {
	...
	CoinType  proto1.CoinType `protobuf:"varint,4,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
	Proof     *proto1.Proof   `protobuf:"bytes,5,opt,name=proof,proto3" json:"proof,omitempty"`
...
func (m *MsgAddToInTxTracker) GetCoinType() proto1.CoinType {
	if m != nil {
		return m.CoinType
	}
...
func (m *MsgAddToInTxTracker) GetProof() *proto1.Proof {
	if m != nil {
		return m.Proof
	}
	return nil
...
func (m *MsgAddToOutTxTracker) GetProof() *proto1.Proof {
	if m != nil {
		return m.Proof
	}
	return nil
...
type MsgVoteOnObservedOutboundTx struct {
	...
	Status                         proto1.ReceiveStatus                    `protobuf:"varint,6,opt,name=status,proto3,enum=pkg.ReceiveStatus" json:"status,omitempty"`
	...
	CoinType                       proto1.CoinType                         `protobuf:"varint,9,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
}
...
func (m *MsgVoteOnObservedOutboundTx) GetStatus() proto1.ReceiveStatus {
	if m != nil {
		return m.Status
	}
	return proto1.ReceiveStatus_Created
...
func (m *MsgVoteOnObservedOutboundTx) GetCoinType() proto1.CoinType {
	if m != nil {
		return m.CoinType
	}
	return proto1.CoinType_Zeta
...
type MsgVoteOnObservedInboundTx struct {
	...
	CoinType      proto1.CoinType `protobuf:"varint,12,opt,name=coin_type,json=coinType,proto3,enum=pkg.CoinType" json:"coin_type,omitempty"`
...
func (m *MsgVoteOnObservedInboundTx) GetCoinType() proto1.CoinType {
	if m != nil {
		return m.CoinType
	}
	return proto1.CoinType_Zeta
...
var fileDescriptor_81d6d611190b7635 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= proto1.ReceiveStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
