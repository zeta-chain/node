...
type MsgVoteOutbound struct {
	...
	ObservationMode                   ObservationMode        `protobuf:"varint,13,opt,name=observation_mode,json=observationMode,proto3,enum=zetachain.zetacore.crosschain.ObservationMode" json:"observation_mode,omitempty"`
}
...
func (m *MsgVoteOutbound) GetObservationMode() ObservationMode {
	if m != nil {
		return m.ObservationMode
	}
	return ObservationMode_SAFE
}
...
type MsgVoteInbound struct {
	...
	ObservationMode ObservationMode `protobuf:"varint,21,opt,name=observation_mode,json=observationMode,proto3,enum=zetachain.zetacore.crosschain.ObservationMode" json:"observation_mode,omitempty"`
}
...
func (m *MsgVoteInbound) GetObservationMode() ObservationMode {
	if m != nil {
		return m.ObservationMode
	}
	return ObservationMode_SAFE
...
var fileDescriptor_15f0860550897740 = []byte{
	...
	,
}
...
func (m *MsgVoteOutbound) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ObservationMode != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.ObservationMode))
		i--
		dAtA[i] = 0x68
	}
...
func (m *MsgVoteOutbound) Size() (n int) {
	...
	if m.ObservationMode != 0 {
		n += 1 + sovTx(uint64(m.ObservationMode))
	}
	return n
}
...
func (m *MsgVoteInbound) Size() (n int) {
	...
	if m.ObservationMode != 0 {
		n += 2 + sovTx(uint64(m.ObservationMode))
	}
	return n
}
...
func (m *MsgVoteOutbound) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ObservationMode", wireType)
			}
			m.ObservationMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ObservationMode |= ObservationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
