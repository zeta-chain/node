...
type QueryZetaAccountingResponse struct {
	...
	AbortedGasAmount   string `protobuf:"bytes,2,opt,name=aborted_gas_amount,json=abortedGasAmount,proto3" json:"aborted_gas_amount,omitempty"`
	AbortedErc20Amount string `protobuf:"bytes,3,opt,name=aborted_erc20_amount,json=abortedErc20Amount,proto3" json:"aborted_erc20_amount,omitempty"`
}
...
func (m *QueryZetaAccountingResponse) GetAbortedGasAmount() string {
	if m != nil {
		return m.AbortedGasAmount
	}
	return ""
}

func (m *QueryZetaAccountingResponse) GetAbortedErc20Amount() string {
	if m != nil {
		return m.AbortedErc20Amount
	}
	return ""
}
...
var fileDescriptor_65a992045e92a606 = []byte{
	...
	,
}
...
func (m *QueryZetaAccountingResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AbortedErc20Amount) > 0 {
		i -= len(m.AbortedErc20Amount)
		copy(dAtA[i:], m.AbortedErc20Amount)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.AbortedErc20Amount)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.AbortedGasAmount) > 0 {
		i -= len(m.AbortedGasAmount)
		copy(dAtA[i:], m.AbortedGasAmount)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.AbortedGasAmount)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *QueryZetaAccountingResponse) Size() (n int) {
	...
	l = len(m.AbortedGasAmount)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	l = len(m.AbortedErc20Amount)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
...
func (m *QueryZetaAccountingResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.AbortedGasAmount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.AbortedErc20Amount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
