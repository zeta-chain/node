...
type QueryListPendingCctxWithinRateLimitResponse struct {
	...
	ValueWithinWindow uint64          `protobuf:"varint,3,opt,name=value_within_window,json=valueWithinWindow,proto3" json:"value_within_window,omitempty"`
	RateLimitExceeded bool            `protobuf:"varint,4,opt,name=rate_limit_exceeded,json=rateLimitExceeded,proto3" json:"rate_limit_exceeded,omitempty"`
}
...
func (m *QueryListPendingCctxWithinRateLimitResponse) GetValueWithinWindow() uint64 {
	if m != nil {
...
var fileDescriptor_65a992045e92a606 = []byte{
	...
	,
}
...
func (m *QueryListPendingCctxWithinRateLimitResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValueWithinWindow", wireType)
			}
			m.ValueWithinWindow = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValueWithinWindow |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
