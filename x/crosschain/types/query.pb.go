...
type QueryConvertGasToZetaResponse struct {
	Zeta            string `protobuf:"bytes,1,opt,name=zeta,proto3" json:"zeta,omitempty"`
	ZetaBlockHeight uint64 `protobuf:"varint,2,opt,name=ZetaBlockHeight,proto3" json:"ZetaBlockHeight,omitempty"`
}
...
func (m *QueryConvertGasToZetaResponse) GetZeta() string {
	if m != nil {
		return m.Zeta
	}
	return ""
...
var fileDescriptor_65a992045e92a606 = []byte{
	...
	,
}
...
func (m *QueryConvertGasToZetaResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Zeta) > 0 {
		i -= len(m.Zeta)
		copy(dAtA[i:], m.Zeta)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Zeta)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryConvertGasToZetaResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Zeta", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Zeta = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
