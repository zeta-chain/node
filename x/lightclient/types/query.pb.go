...
type QueryVerificationFlagsResponse struct {
	VerificationFlags []VerificationFlags `protobuf:"bytes,1,rep,name=verification_flags,json=verificationFlags,proto3" json:"verification_flags"`
}
...
var fileDescriptor_03e46747c4ffba77 = []byte{
	...
	,
}
...
func (m *QueryVerificationFlagsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VerificationFlags) > 0 {
		for iNdEx := len(m.VerificationFlags) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.VerificationFlags[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryVerificationFlagsResponse) Size() (n int) {
	...
	_ = l
	if len(m.VerificationFlags) > 0 {
		for _, e := range m.VerificationFlags {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryVerificationFlagsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.VerificationFlags = append(m.VerificationFlags, VerificationFlags{})
			if err := m.VerificationFlags[len(m.VerificationFlags)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
