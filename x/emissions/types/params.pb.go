...
type Params struct {
	...
	PendingBallotsDeletionBufferBlocks int64                       `protobuf:"varint,12,opt,name=pending_ballots_deletion_buffer_blocks,json=pendingBallotsDeletionBufferBlocks,proto3" json:"pending_ballots_deletion_buffer_blocks,omitempty"`
}
...
func (m *Params) GetPendingBallotsDeletionBufferBlocks() int64 {
	if m != nil {
		return m.PendingBallotsDeletionBufferBlocks
	}
	return 0
}
...
var fileDescriptor_259272924aec0acf = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PendingBallotsDeletionBufferBlocks != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.PendingBallotsDeletionBufferBlocks))
		i--
		dAtA[i] = 0x60
	}
	{
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovParams(uint64(l))
	if m.PendingBallotsDeletionBufferBlocks != 0 {
		n += 1 + sovParams(uint64(m.PendingBallotsDeletionBufferBlocks))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingBallotsDeletionBufferBlocks", wireType)
			}
			m.PendingBallotsDeletionBufferBlocks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PendingBallotsDeletionBufferBlocks |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
