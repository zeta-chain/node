...
func (m *TxHashList) GetSinger() string {
	if m != nil {
		return m.Singer
	}
	return ""
...
var fileDescriptor_803e3aa779e26dde = []byte{
	...
	0x67, 0x10, 0x94, 0x07, 0x12, 0x2f, 0xce, 0xcc, 0x4b, 0x4f, 0x2d, 0x92, 0x60, 0x82, 0x88, 0x43,
	...
	0x8b, 0x93, 0xd8, 0xc0, 0x81, 0x68, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xfa, 0xb1, 0xba, 0xdd,
	0x65, 0x01, 0x00, 0x00,
}
...
func (m *TxHashList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Singer) > 0 {
		...
		i = encodeVarintOutTxTracker(dAtA, i, uint64(len(m.Singer)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.TxHash) > 0 {
