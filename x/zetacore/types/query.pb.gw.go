...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta-chain", "zetacore", "params"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_Query_OutTxTracker_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"zeta-chain", "zetacore", "outTxTracker", "index"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OutTxTrackerAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta-chain", "zetacore", "outTxTracker"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OutTxTrackerAllByChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta-chain", "zetacore", "outTxTrackerByChain"}, "", runtime.AssumeColonVerbOpt(true)))
