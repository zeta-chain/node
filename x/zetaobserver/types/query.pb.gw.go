...
var (
	...
	pattern_Query_AllObserverMappers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zeta-chain", "zetacore", "zetaobserver", "all_observer_mappers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SupportedChains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"zeta-chain", "zetacore", "zetaobserver", "supportedChains"}, "", runtime.AssumeColonVerbOpt(true)))
)
