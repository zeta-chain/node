...
type MsgUpdateChainInfo struct {
	Creator string       `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Chain   chains.Chain `protobuf:"bytes,2,opt,name=chain,proto3" json:"chain"`
}
...
var fileDescriptor_42e081863c477116 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	UpdateRemoveInfo(ctx context.Context, in *MsgRemoveChainInfo, opts ...grpc.CallOption) (*MsgRemoveChainInfoResponse, error)
...
func (c *msgClient) UpdateRemoveInfo(ctx context.Context, in *MsgRemoveChainInfo, opts ...grpc.CallOption) (*MsgRemoveChainInfoResponse, error) {
	out := new(MsgRemoveChainInfoResponse)
	err := c.cc.Invoke(ctx, "/zetachain.zetacore.authority.Msg/UpdateRemoveInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	UpdateRemoveInfo(context.Context, *MsgRemoveChainInfo) (*MsgRemoveChainInfoResponse, error)
...
func (*UnimplementedMsgServer) UpdateRemoveInfo(ctx context.Context, req *MsgRemoveChainInfo) (*MsgRemoveChainInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateRemoveInfo not implemented")
}
...
func _Msg_UpdateRemoveInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgRemoveChainInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).UpdateRemoveInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zetachain.zetacore.authority.Msg/UpdateRemoveInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).UpdateRemoveInfo(ctx, req.(*MsgRemoveChainInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateRemoveInfo",
			Handler:    _Msg_UpdateRemoveInfo_Handler,
		},
		{
