...
type MsgUpdateContractBytecode struct {
	...
	NewBytecode     []byte `protobuf:"bytes,3,opt,name=new_bytecode,json=newBytecode,proto3" json:"new_bytecode,omitempty"`
}
...
func (m *MsgUpdateContractBytecode) GetNewBytecode() []byte {
	if m != nil {
		return m.NewBytecode
	}
	return nil
}
...
var fileDescriptor_197fdedece277fa0 = []byte{
	...
	,
}
...
func (m *MsgUpdateContractBytecode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NewBytecode) > 0 {
		i -= len(m.NewBytecode)
		copy(dAtA[i:], m.NewBytecode)
		i = encodeVarintTx(dAtA, i, uint64(len(m.NewBytecode)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *MsgUpdateContractBytecode) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewBytecode", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewBytecode = append(m.NewBytecode[:0], dAtA[iNdEx:postIndex]...)
			if m.NewBytecode == nil {
				m.NewBytecode = []byte{}
			}
			iNdEx = postIndex
		default:
