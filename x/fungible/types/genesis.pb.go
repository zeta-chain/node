...
type GenesisState struct {
	...
	ForeignCoinList []ForeignCoin   `protobuf:"bytes,2,rep,name=foreignCoinList,proto3" json:"foreignCoinList"`
...
func (m *GenesisState) GetForeignCoinList() []ForeignCoin {
	if m != nil {
		return m.ForeignCoinList
	}
	return nil
}
...
var fileDescriptor_11e46382f3a6d0c2 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForeignCoinList) > 0 {
		for iNdEx := len(m.ForeignCoinList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ForeignCoinList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.ForeignCoinList) > 0 {
		for _, e := range m.ForeignCoinList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForeignCoinList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ForeignCoinList = append(m.ForeignCoinList, ForeignCoin{})
			if err := m.ForeignCoinList[len(m.ForeignCoinList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
