...
func SimulateUpdateGasPriceIncreaseFlags(k keeper.Keeper) simtypes.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accounts []simtypes.Account, _ string,
		...
		if err != nil {
			return simtypes.NoOpMsg(types.ModuleName, TypeMsgUpdateGasPriceIncreaseFlags, err.Error()), nil, nil
		}
		...
		if err != nil {
			return simtypes.NoOpMsg(types.ModuleName, TypeMsgUpdateGasPriceIncreaseFlags, err.Error()), nil, err
		}
