...
type MsgResetChainNonces struct {
	Creator        string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	ChainId        int64  `protobuf:"varint,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	ChainNonceLow  uint64 `protobuf:"varint,3,opt,name=chain_nonce_low,json=chainNonceLow,proto3" json:"chain_nonce_low,omitempty"`
	ChainNonceHigh uint64 `protobuf:"varint,4,opt,name=chain_nonce_high,json=chainNonceHigh,proto3" json:"chain_nonce_high,omitempty"`
}
...
func (m *MsgResetChainNonces) GetChainNonceLow() uint64 {
	if m != nil {
...
func (m *MsgResetChainNonces) GetChainNonceHigh() uint64 {
	if m != nil {
...
var fileDescriptor_1bcd40fa296a2b1d = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChainNonceLow |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChainNonceHigh |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
