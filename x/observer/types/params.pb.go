...
type ChainParams struct {
	...
	// stability pool
	StabilityPoolPercentage int64 `protobuf:"varint,20,opt,name=stability_pool_percentage,json=stabilityPoolPercentage,proto3" json:"stability_pool_percentage,omitempty"`
}
...
func (m *ChainParams) GetStabilityPoolPercentage() int64 {
	if m != nil {
...
var fileDescriptor_e7fa4666eddf88e5 = []byte{
	...
	0xde, 0xb7, 0xdd, 0x7c, 0xb0, 0x06, 0xe6, 0x00, 0xf9, 0x7c, 0x2d, 0x1f, 0x3d, 0x46, 0x77, 0xdc,
	0xd2, 0x5f, 0xa0, 0xfb, 0xae, 0xab, 0x05, 0x35, 0x95, 0xaa, 0xb3, 0xec, 0xf2, 0xda, 0x4e, 0x66,
	0x27, 0xda, 0x6f, 0xd4, 0x1f, 0x9c, 0x68, 0x97, 0xd7, 0xd3, 0xef, 0x5e, 0x9c, 0x8f, 0xbc, 0x97,
	0xe7, 0x23, 0xef, 0xbf, 0xf3, 0x91, 0xf7, 0xf7, 0xc5, 0x68, 0xeb, 0xe5, 0xc5, 0x68, 0xeb, 0x9f,
	0x8b, 0xd1, 0xd6, 0x2f, 0x9f, 0xa4, 0xc2, 0x64, 0x55, 0x1c, 0x32, 0x28, 0xec, 0x0d, 0xf8, 0x69,
	0x73, 0x19, 0x4a, 0x48, 0xf8, 0xe4, 0xec, 0xf5, 0x55, 0x68, 0x56, 0x25, 0xd7, 0xf1, 0x1d, 0x7b,
	0xfb, 0x3d, 0xfa, 0x3f, 0x00, 0x00, 0xff, 0xff, 0xac, 0x61, 0x63, 0x6e, 0x93, 0x05, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 20:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StabilityPoolPercentage |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
