...
type Params struct {
	...
	BalllotMaxAge  int64             `protobuf:"varint,3,opt,name=balllot_max_age,json=balllotMaxAge,proto3" json:"balllot_max_age,omitempty"`
}
...
func (m *Params) GetBalllotMaxAge() int64 {
	if m != nil {
		return m.BalllotMaxAge
	}
	return 0
}
...
var fileDescriptor_4542fa62877488a1 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BalllotMaxAge != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.BalllotMaxAge))
		i--
		dAtA[i] = 0x18
	}
...
func (m *Params) Size() (n int) {
	...
	if m.BalllotMaxAge != 0 {
		n += 1 + sovParams(uint64(m.BalllotMaxAge))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BalllotMaxAge", wireType)
			}
			m.BalllotMaxAge = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BalllotMaxAge |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
