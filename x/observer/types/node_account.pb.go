...
import (
	...
	crypto "github.com/zeta-chain/zetacore/pkg/crypto"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type NodeAccount struct {
	...
	NodeStatus     NodeStatus        `protobuf:"varint,4,opt,name=nodeStatus,proto3,enum=observer.NodeStatus" json:"nodeStatus,omitempty"`
}
...
func init() {
	proto.RegisterEnum("observer.NodeStatus", NodeStatus_name, NodeStatus_value)
	proto.RegisterType((*NodeAccount)(nil), "observer.NodeAccount")
}
...
var fileDescriptor_6f54e38f9d1a9953 = []byte{
	...
	,
}
