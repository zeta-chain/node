...
export interface ZetaMPINonEthInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "ZetaSent(address,uint256,bytes,uint256,uint256,bytes,bytes)": EventFragment;
  };
...
export interface ZetaMPINonEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZetaMPINonEthInterface;
  ...
  filters: {
    ...
    "ZetaSent(address,uint256,bytes,uint256,uint256,bytes,bytes)"(
      originSenderAddress?: string | null,
