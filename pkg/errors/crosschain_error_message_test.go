...
func TestParseCCTXErrorMessage(t *testing.T) {
...
func Test_SplitErrorMessage(t *testing.T) {
	...
	t.Run("SplitErrorMessage with prefix and suffix errors", func(t *testing.T) {
		m := `error_cause1:{"message":"message","error":"error_cause","method":"","contract":"","args":"","revert_reason":""}: error_cause2 : {"message":"message","error":"error_cause","method":"","contract":"","args":"","revert_reason":""}`
		errorLists := cctxerror.SplitErrorMessage(m)
