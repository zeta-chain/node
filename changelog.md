...
* [3506](https://github.com/zeta-chain/node/pull/3506) - defina `ObservationMode` enum and add it to `InboundParams`, `OutboundParams`, `MsgVoteInbound` and `MsgVoteOutbound`
