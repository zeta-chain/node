...
## zetacored query crosschain get-tss-address
...
## zetacored query fungible params
...
* [zetacored query observer list-core-params](#zetacored-query-observer-list-core-params)	 - Query GetCoreParams
* [zetacored query observer list-node-account](#zetacored-query-observer-list-node-account)	 - list all NodeAccount
* [zetacored query observer list-observer](#zetacored-query-observer-list-observer)	 - Query All Observer Mappers
* [zetacored query observer params](#zetacored-query-observer-params)	 - shows the parameters of the module
...
* [zetacored query observer show-core-params](#zetacored-query-observer-show-core-params)	 - Query GetCoreParamsForChain
...
* [zetacored query observer show-observer](#zetacored-query-observer-show-observer)	 - Query ObserversByChainAndType , Use common.chain for querying
...
## zetacored query observer list-core-params
...
## zetacored query observer list-observer

Query All Observer Mappers

```
zetacored query observer list-observer [flags]
```
...
## zetacored query observer params
...
## zetacored query observer show-core-params

Query GetCoreParamsForChain

```
zetacored query observer show-core-params [chain-id] [flags]
```
...
```
      ...
      --grpc-insecure      allow gRPC over insecure channels, if not TLS the server must use TLS
      --height int         Use a specific height to query state at (this can error if the node is pruning state)
  -h, --help               help for show-core-params
      --node string        [host]:[port] to Tendermint RPC interface for this chain 
  -o, --output string      Output format (text|json) 
```
...
## zetacored query observer show-observer
...
* [zetacored tx](#zetacored-tx)	 - Transactions subcommands
* [zetacored tx crosschain add-to-in-tx-tracker](#zetacored-tx-crosschain-add-to-in-tx-tracker)	 - Add a in-tx-tracker 
				Use 0:Zeta,1:Gas,2:ERC20
* [zetacored tx crosschain add-to-out-tx-tracker](#zetacored-tx-crosschain-add-to-out-tx-tracker)	 - Add a out-tx-tracker
* [zetacored tx crosschain create-tss-voter](#zetacored-tx-crosschain-create-tss-voter)	 - Create a new TSSVoter
* [zetacored tx crosschain gas-price-voter](#zetacored-tx-crosschain-gas-price-voter)	 - Broadcast message gasPriceVoter
* [zetacored tx crosschain inbound-voter](#zetacored-tx-crosschain-inbound-voter)	 - Broadcast message sendVoter
...
* [zetacored tx crosschain nonce-voter](#zetacored-tx-crosschain-nonce-voter)	 - Broadcast message nonceVoter
* [zetacored tx crosschain outbound-voter](#zetacored-tx-crosschain-outbound-voter)	 - Broadcast message receiveConfirmation
* [zetacored tx crosschain remove-from-out-tx-tracker](#zetacored-tx-crosschain-remove-from-out-tx-tracker)	 - Remove a out-tx-tracker
...
```
zetacored tx crosschain add-to-out-tx-tracker [chain] [nonce] [tx-hash] [flags]
```
...
```
  ...
  -b, --broadcast-mode string    Transaction broadcasting mode (sync|async|block) 
      ...
      --gas-prices string        Gas prices in decimal format to determine the transaction fee (e.g. 0.1uatom)
      --generate-only            Build an unsigned transaction and write it to STDOUT (when enabled, the local Keybase only accessed when providing a key name)
  -h, --help                     help for add-to-out-tx-tracker
      --keyring-backend string   Select keyring's backend (os|file|kwallet|pass|test|memory) 
      --keyring-dir string       The client Keyring directory; if omitted, the default 'home' directory will be used
      --ledger                   Use a connected Ledger device
      --node string              [host]:[port] to tendermint rpc interface for this chain 
...
## zetacored tx crosschain create-tss-voter
...
## zetacored tx crosschain gas-price-voter
...
## zetacored tx crosschain nonce-voter
...
* [zetacored tx gov submit-legacy-proposal community-pool-spend](#zetacored-tx-gov-submit-legacy-proposal-community-pool-spend)	 - Submit a community pool spend proposal
...
## zetacored tx gov submit-legacy-proposal community-pool-spend
...
Example:
$ zetacored tx gov submit-proposal community-pool-spend [path/to/proposal.json] --from=[key_or_address]
...

{
  ...
  "recipient": "zeta1s5afhd6gxevu37mkqcvvsj8qeylhn0rz46zdlq",
  "amount": "1000stake",
  "deposit": "1000stake"
}

```
zetacored tx gov submit-legacy-proposal community-pool-spend [proposal-file] [flags]
```
...
* [zetacored tx](#zetacored-tx)	 - Transactions subcommands
* [zetacored tx observer add-blame-vote](#zetacored-tx-observer-add-blame-vote)	 - Broadcast message add-blame-vote
...
* [zetacored tx observer update-client-params](#zetacored-tx-observer-update-client-params)	 - Broadcast message updateClientParams
* [zetacored tx observer update-crosschain-flags](#zetacored-tx-observer-update-crosschain-flags)	 - Update crosschain flags
...
## zetacored tx observer add-blame-vote
...
## zetacored tx observer update-client-params
...
## zetacored tx observer update-crosschain-flags
